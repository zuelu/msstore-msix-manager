...
- 支持简体中文和英文界面切换。
- 支持在关于页面检查软件更新、查看更新日志、下载并手动安装新版本。
...
6. 需要下载时，点击下载按钮。
7. 需要安装或更新应用时，点击“安装/更新”按钮。
8. 如需安装历史版本，可在本地已下载安装包列表中右键选择安装。
9. 如需检查本软件更新，可进入“关于”页面点击“检查更新”。
...
- Manually install or update with button actions.
...
- Show clear diagnostic information when installation fails.
